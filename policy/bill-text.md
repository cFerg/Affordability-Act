...
<!--
SUMMARY:
Applies valuation realism to apartments, condos, and multi-unit housing.
Prevents empty units from inflating rent for occupied tenants.
Requires rent to reflect base cost, condition, and actual occupancy rather than market manipulation.
Addresses large-scale vacancy, speculative holding, and misuse of rental pricing models.
-->
...
- provided utilities,
- amenities offered,
and may not exceed reasonable residential equivalents.

---

## Example Scenarios (Illustrative)

**Example 1: Vacancy Cost Abuse**  
An apartment building has 40 units, but only 15 are rented. Remaining tenants see rent increases.  
→ This is prohibited. Vacancy costs belong to the owner.

**Example 2: Unequal Unit Pricing**  
A landlord charges identical rent for a 2-bedroom and a 4-bedroom unit.  
→ Rent must be proportionally allocated.

**Example 3: Student Rent Inflation**  
A landlord raises rent only during the academic year near a university.  
→ Seasonal student-based inflation is prohibited.

---

## Why This Section Exists

Rent inflation driven by vacancy, speculation, and unequal pricing:
- punishes tenants,
- destabilizes communities,
- and accelerates housing insecurity.
...
<!--
SUMMARY:
Separates emergency and non-emergency medical care for fair cost allocation.
Guarantees year-round enrollment access for Medicaid and similar programs.
Defines essential medical items that must be publicly covered.
Prevents medical costs from becoming a primary driver of financial instability.
-->
...
## Plain-English Summary  
Access to healthcare should not depend on employment timing, administrative windows, or emergency circumstances beyond a person’s control. This section separates emergency from non-emergency care, ensures continuous coverage access, and guarantees affordability of essential medical items without price exploitation.
...
- public emergency services,
- or public insurance mechanisms,
and may not result in excessive out-of-pocket charges.
...
A patient is forced into an ambulance during a medical emergency.  
→ Excessive personal billing is prohibited.

**Example 2: Missed Enrollment Window**  
An employee loses coverage after employer enrollment closes and is denied Medicaid.  
→ Provisional coverage or special enrollment is required.

**Example 3: Insulin Price Spike**  
A manufacturer raises insulin prices without cost justification.  
→ This violates essential medical pricing controls.
...
- and punishes people for timing beyond their control.
...
<!--
SUMMARY:
Aligns taxes, fees, and public costs with real property value, income, and affordability.
Prevents secondary inflation through unchecked tax hikes and assessment abuse.
Addresses tariff impacts on housing, vehicles, and essential materials.
Recognizes public research funding as long-term affordability infrastructure supporting jobs, education, and cost reduction.
-->
...
## Plain-English Summary  
Taxes, fees, and public costs should reflect real value and public benefit, not inflate prices or punish individuals unfairly. This section prevents secondary inflation caused by tax abuse, misaligned assessments, and tariffs, while recognizing public research and infrastructure funding as long-term affordability investments.
...
Tax rates may not increase solely due to rising market prices where property value has not materially changed.
...
A property’s tax bill rises sharply despite no improvements.  
→ Violates assessment alignment rules.
...
When taxes and public funding are misaligned:
- prices rise invisibly,
- jobs disappear,
- innovation stalls.
...
<!--
SUMMARY:
Restores accountability for intentional damage, waste, and fraud that inflate prices.
Treats deliberate food spoilage as more harmful than theft.
Prevents cash-only schemes and payment evasion.
Ensures affordability protections are not undermined by bad-faith behavior.
-->
...
## Plain-English Summary  
Affordability depends not only on fair pricing, but on responsible participation. Deliberate waste, fraud, and abuse increase costs for everyone. This section restores accountability for intentional damage, food waste, payment abuse, and exploitative behavior that distorts prices and undermines public trust.
...
The existence of insurance coverage does not absolve individuals from responsibility for intentional harm.
...
Deliberately placing perishable food in conditions that cause spoilage constitutes a violation separate from theft.
...
- cash,
- check,
or other methods that eliminate verifiable transaction records.
...
**Example 1: Deliberate Store Damage**  
An individual intentionally destroys merchandise assuming insurance will cover it.  
→ The individual may be charged for damages.

**Example 2: Food Spoilage Abuse**  
Frozen food is deliberately left on unrefrigerated shelves to spoil.  
→ This may be penalized more severely than theft.

**Example 3: Cash-Only Rent Scheme**  
A landlord requires cash-only rent to avoid records.  
→ This violates payment integrity rules.

---

## Why This Section Exists

Unchecked abuse and waste:
- inflate prices,
- increase insurance claims,
- and penalize responsible consumers.
...
<!--
SUMMARY:
Removes artificial academic and administrative barriers that inflate education costs.
Guarantees fair transfer credit treatment and unrestricted major mobility.
Protects students from system errors, probation traps, and aid disruptions.
Addresses housing, food access, and loan inequities that force students out of education.
-->
...
## Plain-English Summary  
Education affordability is not just tuition — it includes housing, food, credit recognition, and system fairness. This section removes artificial barriers that trap students financially, ensures credits follow the student, and prevents administrative failures from destroying educational paths.
...
Institutions may not require excessive coursework unrelated to a student’s degree path solely to extend enrollment.
...
Credits earned at accredited institutions must transfer with equivalent weight.

**10.2.2 Prohibited Credit Caps**  
Arbitrary limits on transferable credits are prohibited.
...
A student transfers from IST to Engineering, then back to IST.  
Credits earned may not be invalidated or locked to a single pathway.
...
Students may not be penalized due to:
- system errors,
- delayed grade processing,
- administrative faults.

**10.3.2 Appeal & Correction Window**  
Institutions must provide correction mechanisms before probation or dismissal.
...
Housing and financial aid may not be withdrawn due to:
- unresolved administrative disputes,
- short-term enrollment anomalies.

**10.4.2 Housing Equity**  
...
Relief programs must not discriminate based on loan origin.

**10.5.2 Living-Cost Transparency**  
...
**Example 1: Credit Trap**  
A student is forced to retake passed courses after changing majors.  
→ Prohibited under credit persistence rules.

**Example 2: Administrative Failure**  
System errors place a student on probation, triggering housing loss.  
→ Institution must restore standing and aid.

---

## Why This Section Exists

Education should expand opportunity — not become a financial snare.
...
<!--
SUMMARY:
Establishes uniform enforcement so affordability protections are real, not optional.
Applies the Act equally to individuals, corporations, trusts, institutions, and foreign owners.
Defines penalties, restitution, corrective orders, and anti-avoidance clawbacks.
Prevents contract waivers, shell transfers, and strategic bankruptcy from defeating accountability.
-->
...
## Plain-English Summary  
Affordability protections are meaningless without enforcement. This section establishes uniform enforcement standards, meaningful remedies, and clear accountability to ensure that no individual, corporation, or institution can evade the protections of this Act through loopholes, delay, or power imbalance.
...
Contracts, terms of service, or private agreements may not waive rights or protections established under this Act.
...
Enforcement by one authority does not preclude action by another where violations overlap.
...
Transfers of assets, property, or control intended to evade enforcement are voidable.

**11.4.2 Lookback Period**  
Enforcement actions may examine transactions occurring within a defined lookback period where avoidance is suspected.

**11.4.3 Beneficial Ownership Disclosure**  
Hidden ownership structures may be disregarded for enforcement purposes.
...
when determining relief eligibility.
...
**Example 1: Corporate Evasion**  
A company transfers properties between subsidiaries to avoid price caps.  
→ Transfers are voided and enforcement proceeds against beneficial owners.

**Example 2: Strategic Bankruptcy**  
An investor files bankruptcy while retaining asset control through relatives.  
→ Court may disregard the structure and enforce penalties.

**Example 3: Contractual Waiver Attempt**  
A lease attempts to waive tenant rights under this Act.  
...
Without enforcement:
- affordability protections collapse,
